...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        B2UserBasicFields: function B2UserBasicFields() {
            return __webpack_require__.e/* import() */(20).then(__webpack_require__.bind(null, "./resources/assets/js/components/user/fields/B2UserBasicFields.vue"));
        },
        B2UserSecurityFields: function B2UserSecurityFields() {
            return __webpack_require__.e/* import() */(17).then(__webpack_require__.bind(null, "./resources/assets/js/components/user/fields/B2UserSecurityFields.vue"));
        },
        B2UserPreferencesFields: function B2UserPreferencesFields() {
            return __webpack_require__.e/* import() */(19).then(__webpack_require__.bind(null, "./resources/assets/js/components/user/fields/B2UserPreferencesFields.vue"));
        },
        B2UserPrivacyFields: function B2UserPrivacyFields() {
            return __webpack_require__.e/* import() */(18).then(__webpack_require__.bind(null, "./resources/assets/js/components/user/fields/B2UserPrivacyFields.vue"));
        },
