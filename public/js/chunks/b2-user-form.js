...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        B2UserBasicFields: function B2UserBasicFields() {
            return __webpack_require__.e/* import() */(12).then(__webpack_require__.bind(null, "./resources/assets/js/components/user/fields/B2UserBasicFields.vue"));
        },
        B2UserSecurityFields: function B2UserSecurityFields() {
            return __webpack_require__.e/* import() */(9).then(__webpack_require__.bind(null, "./resources/assets/js/components/user/fields/B2UserSecurityFields.vue"));
        },
        B2UserPreferencesFields: function B2UserPreferencesFields() {
            return __webpack_require__.e/* import() */(11).then(__webpack_require__.bind(null, "./resources/assets/js/components/user/fields/B2UserPreferencesFields.vue"));
        },
        B2UserPrivacyFields: function B2UserPrivacyFields() {
            return __webpack_require__.e/* import() */(10).then(__webpack_require__.bind(null, "./resources/assets/js/components/user/fields/B2UserPrivacyFields.vue"));
        },
