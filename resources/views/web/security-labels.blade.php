  ...
  <div>
    <div class="below_nav_container container-fluid p-5 d-flex align-items-center header_image" id="label_header">
      <div class="container header_container_inner">
        <h2 class="text-dark font-weight-strong">{{__('web.title-labels-section1-line1')}}</h2>
        <p class="text-dark font-weight-strong">{{__('web.title-labels-section1-line2')}}</p>
      </div>
    </div>
  </div>
  ...
  <div class="container py-4">
    ...
    <div class="row">
      <div class="col-md-8 py-5">
        {!! __('web.body-labels-section1-line2') !!}
        ...
        <div class="row mt-5">
          <div class="col-md-6 my-4">
            ...
            <h3 class="text-center mt-4">{{__('web.body-labels-section2-point1')}}</h3>
          </div>
          ...
          <div class="col-md-6 my-4">
            ...
            <h3 class="text-center mt-4">{{__('web.body-labels-section2-point2')}}</h3>
          </div>
        </div>
        ...
        <div class="row mt-5">
          <div class="col-md-6 my-4">
            ...
            <h3 class="text-center mt-4"><a href="{{ route('inventory') }}" title="{{__('web.label-product-education')}}">{{__('web.body-labels-section2-point3')}}</a></h3>
          </div>
          ...
          <div class="col-md-6 my-4">
            ...
            <h3 class="text-center mt-4">{{__('web.body-labels-section2-point4')}}</h3>
          </div>
        </div>
