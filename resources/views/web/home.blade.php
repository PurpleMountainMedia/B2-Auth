...
@section('below_nav')
  <div id="particles-js" class="bg-dark">
    <div class="below_nav_container container-fluid p-5 d-flex align-items-center">
      <div class="container">
        <h2 class="text-white font-weight-light">{{__('web.title-hero-primary')}}</h2>
        <a class="btn btn-primary btn-sm" href="{{ route('our-products') }}">{{__('web.label-our-products')}}</a>
      </div>
    </div>
  </div>
...
@section('content')
  <div class="container">
    <div class="row">
        ...
        <div class="card shadow-sm border-0">
          <a class="product_link" href="{{ route('inventory') }}">
            <div class="card-body">
              ...
              <h4 class="text-center mt-3 text-dark">{{__('web.label-product-education')}}</h4>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="col-md-4 p-3">
        <div class="card shadow-sm border-0">
          <a class="product_link" href="{{ route('freedom') }}">
            <div class="card-body">
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" class="heroicon-load-balancer heroicon heroicon-sm d-block m-auto heroicon-b2">
              ...
              <h4 class="text-center mt-3 text-dark">{{__('web.label-product-freedom')}}</h4>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="col-md-4 p-3">
        <div class="card shadow-sm border-0">
          <a class="product_link" href="{{ route('security_labels') }}">
            <div class="card-body">
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" class="heroicon-form heroicon heroicon-sm d-block m-auto heroicon-b2">
              ...
              <h4 class="text-center mt-3 text-dark">{{__('web.label-product-labels')}}</h4>
            </div>
          </a>
        </div>
      </div>
        ...
        <div class="card shadow-sm border-0">
          <a class="product_link" href="">
            <div class="card-body">
              ...
              <h4 class="text-center mt-3 text-dark">{{__('web.label-product-finance')}}</h4>
            </div>
          </a>
        </div>
      </div>
        ...
        <div class="card shadow-sm border-0">
          <a class="product_link" href="">
            <div class="card-body">
              ...
              <h4 class="text-center mt-3 text-dark">{{__('web.label-product-people')}}</h4>
            </div>
          </a>
        </div>
      </div>
  ...
  <div class="container mt-4 py-5">
    <div class="row">
      <div class="col-md-12">
        {!!__('web.body-section1-line1')!!}

        <a class="btn btn-outline-primary" href="{{ route('register') }}">{!!__('web.body-section1-button')!!}</a>
      </div>
    </div>
  </div>
  ...
  <div class="py-5 bg-primary mt-5 pattern_bg_primary">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h3 class="text-white text-center">{{__('web.title-section2-line1')}}</h3>
          <h3 class="text-white text-center">{{__('web.title-section2-line2')}}</h3>

          <p class="text-white text-center mt-4">{{__('web.body-section2-line1')}}</p>
          ...
          <div class="row text-white text-center pt-5">
            <div class="col-md-6 mt-5">
              ...
              <h3 class="my-4">{{__('web.body-section2-point1')}}</h3>
            </div>
            <div class="col-md-6 mt-5">
              ...
              <h3 class="my-4">{{__('web.body-section2-point2')}}</h3>
            </div>
          </div>
          ...
          <div class="row text-white text-center pt-5">
            <div class="col-md-6 mt-5">
              ...
              <h3 class="my-4">{{__('web.body-section2-point3')}}</h3>
            </div>
            <div class="col-md-6 mt-5">
              ...
              <h3 class="my-5">{{__('web.body-section2-point4')}}</h3>
            </div>
          </div>

          <div class="row text-white text-center pt-5">
            <button type="button" class="btn btn-secondary btn-lg m-auto" name="button">{{__('web.label-contact')}}</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="py-5 bg-light mt-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h4>{{__('web.title-section3-line1')}}</h4>
        </div>
  ...
  <div class="py-5 bg-white mt-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h4 class="pull-right">{{__('web.title-section4-line1')}}</h4>
        </div>
        <div class="col-md-4 py-4">
          <div class="card bg-light shadow-sm border-0 text-center">
            <div class="card-body">
              <h5 class="card-title mb-4">{{__('web.body-section4-point1-title')}}</h5>
              {!!__('web.body-section4-point1')!!}
            </div>
          </div>
        </div>
        <div class="col-md-4 py-4">
          <div class="card bg-light shadow-sm border-0 text-center">
            <div class="card-body">
              <h5 class="card-title mb-4">{{__('web.body-section4-point2-title')}}</h5>
              {!!__('web.body-section4-point2')!!}
            </div>
          </div>
        </div>
        <div class="col-md-4 py-4">
          <div class="card bg-light shadow-sm border-0 text-center">
            <div class="card-body">
              <h5 class="card-title mb-4">{{__('web.body-section4-point3-title')}}</h5>
              {!!__('web.body-section4-point3')!!}
            </div>
          </div>
        </div>
      </div>
