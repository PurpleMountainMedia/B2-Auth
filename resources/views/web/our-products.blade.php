    ...
    <div class="row h-100">
      <div class="col-md-4 bg-eams h-100 py-5 screen_full_height d-flex align-items-center">
        <div class="w-100">
          ...
          <h1 class="text-dark mt-4">{{__('web.label-product-education')}}</h1>
          <a class="btn btn-dark" href="{{ route('inventory') }}">{{__('web.label-findoutmore')}}</a>
        </div>
      </div>
      <div class="col-md-4 bg-finance h-100 py-5 screen_full_height d-flex align-items-center">
        <div class="w-100">
          ...
          <h1 class="text-dark mt-4">{{__('web.label-product-finance')}} <span class="badge badge-danger">{{__('web.label-comingsoon')}}</span></h1>
          <button disabled class="btn btn-dark" href="#">{{__('web.label-findoutmore')}}</button>
        </div>
      </div>
      <div class="col-md-4 bg-people h-100 py-5 screen_full_height d-flex align-items-center">
        <div class="w-100">
          ...
          <h1 class="text-dark mt-4">{{__('web.label-product-people')}} <span class="badge badge-danger">{{__('web.label-comingsoon')}}</span></h1>
          <button disabled class="btn btn-dark" href="#">{{__('web.label-findoutmore')}}</button>
        </div>
      </div>
    </div>
