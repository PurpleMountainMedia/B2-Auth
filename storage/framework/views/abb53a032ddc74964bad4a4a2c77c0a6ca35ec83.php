...
<?php $__env->startPush('header_scripts'); ?>
  <style media="screen">
    #label_header {
      background: url(<?php echo e(url('storage/web/barcode_image.jpg')); ?>);
    ...
    <div class="row">
      <div class="col-md-8 py-5">
        ...
        <div class="row mt-5">
          <div class="col-md-6 my-4">
            ...
            <h3 class="text-center mt-4"><a href="<?php echo e(route('inventory')); ?>" title="Education Inventory Asset Management Platform">EI Platform</a> Compatible</h3>
          </div>
      ...
      <div class="col-md-4 pt-1">
        <label-chooser-component
          :images="[{
              src: '<?php echo e(url('storage/web/barcode_label_packaging.png')); ?>'
          }]">
        </label-chooser-component>
      </div>
    </div>
