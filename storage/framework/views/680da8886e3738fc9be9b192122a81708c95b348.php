  ...
  <div id="particles-js" class="bg-dark">
    <div class="below_nav_container container-fluid p-5 d-flex align-items-center">
      <div class="container">
        ...
        <a class="btn btn-primary btn-sm" href="<?php echo e(route('our-products')); ?>">Our Products</a>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4 p-3">
        <div class="card shadow-sm border-0">
          <a class="product_link" href="<?php echo e(route('inventory')); ?>">
            <div class="card-body">
  ...
  <div class="container mt-4 py-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <a class="btn btn-outline-primary" href="<?php echo e(route('register')); ?>">Get Started For <span class="badge badge-secondary">Free</span> With B2 Systems</a>
      </div>
    </div>
  </div>
