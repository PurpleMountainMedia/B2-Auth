    ...
    <div class="row h-100">
      <div class="col-md-4 bg-eams h-100 py-5 screen_full_height d-flex align-items-center">
        <div class="w-100">
          ...
          <a class="btn btn-dark" href="<?php echo e(route('inventory')); ?>">Find Out More</a>
        </div>
      </div>
...
<?php echo $__env->make('layouts.full', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>