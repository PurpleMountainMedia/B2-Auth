<?php $__env->startSection('below_nav'); ?>
  <div>
    <div class="below_nav_container container-fluid p-5 d-flex align-items-center header_image" id="asset_discovery_header">
      <div class="container header_container_inner">
        <h2 class="text-dark font-weight-strong">Onsite Asset Discovery Service</h2>
        <p class="text-dark font-weight-strong">Carried out by our experienced auditors</p>
      </div>
    </div>
  </div>
...
<?php $__env->startPush('header_scripts'); ?>
  <style media="screen">
    #asset_discovery_header {
      background: url(<?php echo e(url('storage/web/asset_discovery_header.jpg')); ?>);
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4 my-5">
          ...
          <h4 class="my-4 text-white text-center">Optional barcoding of high value items using our <a class="text-dark" href="<?php echo e('security_labels'); ?>" title="Security Lables">security labels</a></h4>
        </div>
      </div>
