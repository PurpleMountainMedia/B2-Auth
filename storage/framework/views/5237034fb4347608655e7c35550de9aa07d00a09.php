  ...
  <div class="container py-4">
    ...
    <div class="row">
      <div class="col-md-6 py-5">
        ...
        <p>Once device information has been sent to our servers, users will find information about the IT Equipment within their <a href="<?php echo e(route('inventory')); ?>" class="text-primary">Education Inventory</a> dashboard.</p>

        <a href="#downloads" class="btn btn-outline-primary btn-lg mt-4">Download Now</a>

      </div>
      <div class="col-md-6 pt-1">
        <img class="img-fluid" src="<?php echo e(url('storage/web/freedom_screenshot2.png')); ?>" alt="Freedom">
      </div>
    </div>
  </div>
